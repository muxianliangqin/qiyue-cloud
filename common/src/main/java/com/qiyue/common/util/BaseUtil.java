...
public class BaseUtil {
    ...
    public static String encrypt(String text, String salt) throws Exception {
        ...
        byte[] bytes = (text + salt).getBytes(Constant.ENCODE_UTF8);
     ...
     */
    public static boolean slowEquals(String aStr, String bStr) throws UnsupportedEncodingException {
        byte[] a = aStr.getBytes(Constant.ENCODE_UTF8);
        byte[] b = bStr.getBytes(Constant.ENCODE_UTF8);
