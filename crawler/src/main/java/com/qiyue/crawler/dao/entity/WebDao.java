...
public interface WebDao extends JpaRepository<WebEntity, Long>, JpaSpecificationExecutor<WebEntity> {
    Page<WebEntity> findAllByWebIdAndState(Long webId, Integer state, Pageable pageable);
