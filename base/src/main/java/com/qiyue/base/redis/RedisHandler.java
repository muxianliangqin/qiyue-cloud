...
public class RedisHandler {
    ...
    private StringTemplate stringTemplate = new StringTemplate();
    private HashTemplate hashTemplate = new HashTemplate();
    private ListTemplate listTemplate = new ListTemplate();
    private SetTemplate setTemplate = new SetTemplate();
     ...
     *
     * @param key 键 不能为null
     * @return 时间(秒) 返回0代表为永久有效, key存在返回>0,key不存在返回-2(不确定是否有其他值)
     */
